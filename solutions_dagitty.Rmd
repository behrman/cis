...
The code below used dagitty version `r v$loadedversion`. If the CRAN version is less than this version, the current development version can be installed with:
