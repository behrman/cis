...
`dagitty` does not have a function to calculate sets of variables that satisfy the backdoor criterion. We can use `dagitty::adjustmentSets()` to find adjustment sets and then remove any sets that contain descendants of X.

```{r}
adjustmentSets(fig_3.8, exposure = "X", outcome = "Y", type = "all")
```

These adjustment sets contain no descendants of X, hence they all satisfy the backdoor criterion.
...
These adjustment sets contain no descendants of D, hence they all satisfy the backdoor criterion.
...
These adjustment sets contain no descendants of {D, W}, hence they all satisfy the backdoor criterion.
...
This adjustment set contains no descendants of X and thus satisfies the backdoor criterion to assess the c-specific effect of X on Y.
...
These adjustment sets contain no descendants of X and thus satisfy the backdoor criterion to assess the z-specific effect of X on Y.
